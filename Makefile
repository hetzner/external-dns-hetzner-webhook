KUBERNETES_VERSION ?= 1.37.0 # renovate: datasource=github-releases depName=kubernetes-sigs/controller-tools extractVersion=^envtest-v(?<version>.+)$
EXTERNAL_DNS_VERSION = v0.22.0 # renovate: datasource=github-releases depName=kubernetes-sigs/external-dns
